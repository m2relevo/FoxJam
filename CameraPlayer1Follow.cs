...
public class CameraPlayer1Follow : MonoBehaviour {
	...
	bool CheckXMargin()
	{
		...
		return Mathf.Abs(transform.position.x - player1.position.x) > xMargin;
	}
	...
	bool CheckYMargin()
	{
		...
		return Mathf.Abs(transform.position.y - player1.position.y) > yMargin;
	}
