...
public class CameraPlayer2Follow : MonoBehaviour {
	...
	bool CheckXMargin()
	{
		...
		return Mathf.Abs(transform.position.x - player2.position.x) > xMargin;
	}
	...
	bool CheckYMargin()
	{
		...
		return Mathf.Abs(transform.position.y - player2.position.y) > yMargin;
	}
